...
import { GoogleIcon, FacebookIcon, SitemarkIcon } from '@/Components/Login/CustomIcons'; // Sesuaikan path jika CustomIcons ada di folder Register
import { Head, Link, useForm } from '@inertiajs/react'; // Import Inertia.js hooks and components
